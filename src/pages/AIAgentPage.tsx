...
const initialMessages: Message[] = [
  { role: "assistant", content: "Olá! Sou o agente de IA do **Smart Capital AI**. Posso ajudá-lo a analisar indicadores de estoque, identificar riscos e sugerir prioridades. Como posso ajudar?" },
];
    ...
    <div className="flex flex-col h-[calc(100vh-8rem)] animate-fade-in">
      <div className="glass-card flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-3 p-4 border-b border-border">
          ...
          <div>
            <h3 className="font-semibold text-foreground">Smart Capital AI</h3>
            ...
            <div key={i} className={`flex gap-3 ${msg.role === "user" ? "justify-end" : ""}`}>
              {msg.role === "assistant" && (
                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  <img src={smartCapitalAiIcon} alt="AI" className="w-5 h-5 object-contain" />
                </div>
              )}
